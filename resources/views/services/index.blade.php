    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] flex min-h-screen flex-col">
        ...
        <main class="flex-1 w-full max-w-5xl mx-auto px-6 py-16 lg:py-24">
            <section class="max-w-2xl mb-12">
                <h1 class="text-4xl lg:text-5xl font-semibold leading-tight mb-4">Our Services</h1>
                <p class="text-lg text-[#706f6c] dark:text-[#A1A09A]">
                    We partner with you from strategy through delivery, helping you ship software and grow your brand.
                </p>
            </section>
